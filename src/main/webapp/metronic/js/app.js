...
var App = function () {
    ...
    var handleSidebarToggler = function () {
        ...
        $('.navbar-inner').on('click', '.sidebar-toggler', function (e) {            
            var body = $('body');
            var sidebar = $('.page-sidebar');
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style_color').attr("href", "metronic/css/" + color + ".css");
    ...
    return {
        ...
        showInfoWindow : function(fragment){
        	if(!$("#infoModalDiv").length){
        		$(document.body).append('<div id="infoModalDiv"></div>');
        	}
        	$("#infoModalDiv").html(fragment);
